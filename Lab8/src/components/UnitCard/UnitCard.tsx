                ...
                <Row>
                    ...
                    <Col md={8}>
                        <CardBody>
                            ...
                            <CustomDropdownBoolean label="Нужно совещание?" selectedItem={local_meeting as number} setSelectedItem={setLocal_meeting} disabled={!editMM || is_superuser} className={"w-100"}/>
