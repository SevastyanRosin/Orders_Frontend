...
import {createUnit} from "store/slices/unitsSlice.ts";
import {T_UnitAddData} from "modules/types.ts";
...
const UnitAddPage = () => {
    ...
    const handleCreateUnit = async() => {
        ...
        await dispatch(createUnit(formData as T_UnitAddData))
            ...
            <Row>
                ...
                <Col md={6}>
                    ...
                    <Col className="d-flex justify-content-center gap-5 mt-5">
                        <Button color="success" className="fs-4" onClick={handleCreateUnit}>Создать</Button>
                    </Col>
                </Col>
            </Row>
        </Container>
