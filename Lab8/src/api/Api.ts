...
export interface UpdateCDecreeStatusAdmin {
  /** Status */
  status: number;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  decrees = {
     ...
     * @secure
     */
    decreesUpdateStatusAdminUpdate: (decreeId: string, data: UpdateCDecreeStatusAdmin, params: RequestParams = {}) =>
      this.request<UpdateCDecreeStatusAdmin, any>({
  ...
  units = {
     ...
     * @secure
     */
    unitsUpdateUpdate: (unitId: string, data: Unit, params: RequestParams = {}) =>
